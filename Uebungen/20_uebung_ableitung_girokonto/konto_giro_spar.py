...
# Diese erweitert die Klasse Konto um eine Methode, um einen Geldbetrag von einem Girokonto zu einem anderen zu übertragen.
# Die Methode hat also als Parameter das Zielkonto und den zu überweisenden Betrag.
